...
!     call read_PES_file(inp % pes_files_f(j), inp % npoints_in, inp % nstates, X_dvr, E_f(j,:))
...
!
!  !do i=1, nstates_na
!  !   write(7,'(I5,G30.20 )') i, (eig_sort(i)- eig_na(i))/const % eV
!  !end do
! 
!
...
!
!  ! convert eigenvalues to const % eV units
