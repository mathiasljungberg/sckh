...
def run_test():
    ...
    # check spectrum
    err_code += mod_tests.my_diff_sum_ref('spectrum_resonant_sigma_201.10.dat', '../ref/spectrum_resonant_sigma_201.10.dat')
    err_code += mod_tests.my_diff_sum_ref('spectrum_resonant_sigma_206.27.dat', '../ref/spectrum_resonant_sigma_206.27.dat')
